...
//         isTransparent
//           ? "py-4 bg-transparent"
//           : "py-2 bg-neutral-50/90 backdrop-blur-lg shadow-sm"
//       }`}
//     >
//       <div className="container mx-auto px-4 sm:px-6 lg:px-8">
//         <nav className="flex items-center justify-between">
...
import { Link, useLocation } from "react-router-dom";
import logo from "../assets/logos.png";
import logoScrolled from "../assets/logot2.png";
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <img
              src={isScrolled ? logoScrolled : logo}
              alt="Design Hut Logo"
              className={`object-contain transition-all duration-300 ${isScrolled ? "h-14 sm:h-16" : "h-32 sm:h-36"
                }`}
            />
          </Link>
