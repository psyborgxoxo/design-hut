...
function ContactSection() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-16 md:py-20 bg-[#f5f5f5]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-emerald-950 text-base sm:text-lg leading-relaxed max-w-lg mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-start space-x-4">
                <Phone className="h-5 w-5 text-emerald-950 flex-shrink-0 mt-1" aria-hidden="true" />
                <div>
                  <p className="text-emerald-950 text-xs sm:text-sm uppercase tracking-widest mb-2">Phone</p>
                  <div className="flex flex-col space-y-2">
                    <a
                      href="tel:+918050596670"
                      className="text-emerald-950 hover:text-emerald-800 transition-colors duration-300 text-sm sm:text-base"
              ...
              <div className="flex items-start space-x-4">
                <Mail className="h-5 w-5 text-emerald-950 flex-shrink-0 mt-1" aria-hidden="true" />
                <div>
                  <p className="text-emerald-950 text-xs sm:text-sm uppercase tracking-widest mb-2">Email</p>
                  <a
                    href="mailto:ddsgroups.in@gmail.com"
                    className="text-emerald-950 hover:text-neutral-50 transition-colors duration-300 text-sm sm:text-base break-all"
              ...
              <div className="flex items-start space-x-4">
                <MapPin className="h-5 w-5 text-emerald-950 flex-shrink-0 mt-1" aria-hidden="true" />
                <div>
                  <p className="text-emerald-950 text-xs sm:text-sm uppercase tracking-widest mb-2">Location</p>
                  <p className="text-emerald-950 text-sm sm:text-base">Bengaluru, Karnataka</p>
                </div>
              </div>
            </div>
            ...
            <div
              ref={actionsRef}
              className="md:col-span-2 bg-emerald-950 p-6 md:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
              style={{
                opacity: 0,
                transform: 'translateX(30px)',
                transition: 'opacity 0.8s ease-out, transform 0.8s ease-out'
              ...
              <div className="flex flex-col items-center justify-center h-full space-y-6">
                ...
                <div className="w-full max-w-md space-y-4">
                  ...
                  <button
                    ...
                    className="group w-full bg-emerald-800 hover:bg-emerald-600 text-white px-6 py-4 rounded-xl 
                ...
                <p className="text-white text-xs sm:text-sm text-center mt-6 px-4">
